...
module.exports = {
    respondToMessage: function(message) {
        ...
        if (message.content.startsWith("kz")
            ...
            if (utils.self.chanceOfPosting(2) === true) {
        ...
        /* user specific responses below */
            ...
            if (utils.self.chanceOfPosting(12) === true) {
            ...
            if (utils.self.chanceOfPosting(10) === true) {
            ...
            if (utils.self.chanceOfPosting(3) === true) {
        ...
        else if (utils.self.chanceOfPosting(10000)) {
